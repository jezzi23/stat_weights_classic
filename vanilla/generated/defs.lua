...
sc.spell_flags = {
	...
	on_next_attack = bit.lshift(1, 13),
	uses_attack_speed = bit.lshift(1, 14),
	finishing_move_dmg = bit.lshift(1, 15),
	finishing_move_dur = bit.lshift(1, 16),
	pet = bit.lshift(1, 17),
